...
const translations = {
    ar: {
        ...
        navHome: "الرئيسية",
        footerKeywords: "سوق المشاريع | منصة المشاريع المنزلية في الإمارات | دليل الأسر المنتجة | مشاريع دبي | مشاريع أبوظبي | مشاريع الشارقة | مشاريع عجمان | مشاريع رأس الخيمة | مشاريع الفجيرة | مشاريع أم القيوين",
        navMarket: "السوق",
    ...
    en: {
        ...
        navHome: "Home",
        footerKeywords: "Projects Souq | Home Business Platform in UAE | Productive Families Directory | Dubai Projects | Abu Dhabi Projects | Sharjah Projects | Ajman Projects | Ras Al Khaimah Projects | Fujairah Projects | Umm Al Quwain Projects",
        navMarket: "Market",
