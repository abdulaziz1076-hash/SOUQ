...
const translations = {
    ar: {
        siteTitle: "سوق المشاريع", paidBadge: "مميز", privacy: "سياسة الخصوصية", terms: "شروط الاستخدام",
        dealsTitle: "العروض والباقات:", viewingDeal: "جاري عرض تفاصيل العرض...", expiryUntil: "ينتهي",
        siteSubtitle: "المشاريع في الامارات", navHome: "الرئيسية", navMarket: "السوق", navRegister: "تسجيل مشروع",
        navFavorites: "المفضلة", footerLogo: "سوق المشاريع", footerText: "منصة المشاريع الإماراتية",
        forShopperTitle: "للباحث عن منتج", forShopperDesc: "اكتشف منتجات محلية بأيادٍ إماراتية ومقيمة...",
        forProjectOwnerTitle: "لصاحب المشروع", forProjectOwnerDesc: "سجل مشروعك مجاناً...",
        copyright: "© 2026 سوق المشاريع - جميع الحقوق محفوظة", langBtn: "En",
        heroTitle: "سوق المشاريع", heroSubtitle: "منصة متخصصة في المشاريع المنزلية",
        discoverBtn: "ادخل السوق", joinBtn: "سجل مشروعك", aboutTitle: "من نحن",
        stat1: "مشاريع", stat2: "منتجات متنوعة", stat3: "طلبات تواصل", stat4: "شركاء داعمين",
        badge1: "قريباً", badge2: "قريباً", badge3: "قريباً", badge4: "قريباً",
        navServices: "خدمات المشاريع", navArticles: "المقالات الإرشادية", navDelivery: "شركات التوصيل",
        homeSearchPlaceholder: "ابحث عن منتج أو مشروع...",
        familiesPageTitle: "المشاريع", familiesPageSubtitle: "استعرض المشاريع في الامارات",
        familiesSearchPlaceholder: "ابحث عن مشروع أو منتج...", productsTitle: "المنتجات",
        favoritesPageTitle: "المفضلة", favoritesPageSubtitle: "المنتجات التي أضفتها", emptyFavoritesProducts: "لا توجد منتجات في المفضلة بعد",
        sellerInfo: "معلومات البائع", similarProducts: "منتجات مشابهة", contactSeller: "تواصل مع البائع",
        shareProduct: "مشاركة المنتج", shareProfile: "مشاركة المشروع", specifications: "المواصفات والتفاصيل",
        popupTitle: "كيف تطلب؟", step1: "تصفح المنتجات", step2: "واختر ما يعجبك", step3: "تواصل مع البائع", gotItBtn: "إغلاق",
        shareTitle: "مشاركة المنتج", copyLinkText: "نسخ الرابط", closeShareBtn: "إغلاق",
        offersBtnText: "العروض", offersPageTitle: "العروض الخاصة", offersPageSubtitle: "أحدث العروض والباقات",
        addToFavorites: "تمت الإضافة للمفضلة", removeFromFavorites: "تمت الإزالة من المفضلة", linkCopied: "تم نسخ الرابط!",
        licensed: "مرخص", coverage: "التغطية", descriptionLabel: "نبذة عن المشروع", noContact: "لا توجد معلومات تواصل",
        noProjects: "لا مشاريع متاحة", viewProducts: "المنتجات", call: "اتصال", email: "البريد الإلكتروني",
        registerTitle: "سجل مشروعك الآن", registerViaX: "راسلنا على منصة X", registerViaInstagram: "راسلنا على انستغرام",
        registerViaTikTok: "راسلنا على تيك توك",
        // إضافات نافذة التأكيد
    ...
    en: {
        siteTitle: "Souq Almasharie", registerTitle: "Register Your Project Now", registerViaX: "Message us on X",
        registerViaInstagram: "Message us on Instagram", registerViaTikTok: "Message us on TikTok", paidBadge: "Featured",
        dealsTitle: "Offers & Packages", viewingDeal: "Viewing deal details...", expiryUntil: "Expires",
        siteSubtitle: "Projects in UAE", navHome: "Home", navMarket: "Market", navRegister: "Register Project",
        navFavorites: "Favorites", footerLogo: "Souq Almasharie", footerText: "UAE Projects Platform",
        forShopperTitle: "For Product Seekers", forShopperDesc: "Discover local products made by Emirati and resident hands...",
        forProjectOwnerTitle: "For Project Owners", forProjectOwnerDesc: "Register your project for free...",
        copyright: "© 2026 Souq Almasharie - All Rights Reserved", langBtn: "عربي",
        heroTitle: "Souq Almasharie", heroSubtitle: "A specialized platform supporting projects in the UAE",
        discoverBtn: "Enter the market", joinBtn: "Register Project", aboutTitle: "About Us",
        stat1: "Projects", stat2: "Diverse Products", stat3: "Contact Requests", stat4: "Supporting Partners",
        badge1: "Coming Soon", badge2: "Coming Soon", badge3: "Coming Soon", badge4: "Coming Soon",
        navServices: "Project Services", navArticles: "Guidance Articles", navDelivery: "Delivery Companies",
        homeSearchPlaceholder: "Search for product or project...",
        familiesPageTitle: "Projects", familiesPageSubtitle: "Review the projects in the UAE",
        familiesSearchPlaceholder: "Search for project or product...", productsTitle: "Products",
        favoritesPageTitle: "Favorites", favoritesPageSubtitle: "Your favorite products", emptyFavoritesProducts: "No favorite products yet",
        sellerInfo: "Seller Info", similarProducts: "Similar Products", offersBtnText: "Offers",
        offersPageTitle: "Special Offers", offersPageSubtitle: "Latest offers and packages",
        contactSeller: "Contact Seller", shareProduct: "Share Product", shareProfile: "Share Project",
        specifications: "Specifications & Details", popupTitle: "How to Order?", step1: "Browse Products",
        step2: "Choose what you like", step3: "Contact the Seller", gotItBtn: "Got it",
        shareTitle: "Share Product", copyLinkText: "Copy Link", closeShareBtn: "Close",
        addToFavorites: "Added to favorites", removeFromFavorites: "Removed from favorites", linkCopied: "Link copied!",
        licensed: "Licensed", coverage: "Coverage", descriptionLabel: "About the Project", noContact: "No contact information",
        noProjects: "No projects available", viewProducts: "Products", call: "Call", email: "Email",
